...
//
//        Product p = Product.builder().titleRaw("Wireless Earbuds " + System.currentTimeMillis()).titleNormalized("سماعات لاسلكية").brand("Acme").model("X" + r.nextInt(999)).category("electronics").build();
//        products.save(p);
//
